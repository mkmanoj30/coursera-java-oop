...
public class HelloUCSDWorld extends PApplet {
	...
	public void setup() {
		...
		map = new UnfoldingMap(this,new Google.GoogleTerrainProvider());//Microsoft.AerialProvider(),new Google.GoogleTerrainProvider(),OpenStreetMap.OpenStreetMapProvider();
